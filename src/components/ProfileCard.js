    ...
    return (
        <div className="group shadow-lg flex rounded-lg max-w-xs flex-col overflow-hidden border border-outline bg-surface-alt text-on-surface dark:border-outline-dark dark:bg-surface-dark-alt dark:text-on-surface-dark">
            ...
            <div className="relative h-36">
                ...
                <div className="relative z-10 mx-auto -mt-14 size-28 overflow-hidden rounded-full border-4 border-surface-alt dark:border-surface-dark-alt">
            ...
            <div className="flex flex-col gap-2 p-6 text-center mt-12">
                ...
                <div className="mt-4 flex items-center justify-center gap-6">
                    {/* <!-- Email --> */}
                    <a href="mailto:youremailaddress@email.com" className="text-on-surface hover:text-primary dark:text-on-surface-dark dark:hover:text-primary-dark" aria-label="email">
                    ...
                    {/* <!-- Linkedin --> */}
                    <a href="https://www.linkedin.com" target="_blank" className="text-on-surface hover:text-primary dark:text-on-surface-dark dark:hover:text-primary-dark" aria-label="linkedin">
